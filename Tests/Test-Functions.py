...
print(outer())
"""
 a   a) Inside inner     b) outer inner      c) Error        d) None
----------------------------------------------------------------------------------------------
...
print(third())
"""
b    a) First Second         b) First Second Third           c) Second Third         d) Error
-----------------------------------------------------------------------------------------------
...
a    d) It allows modification of global variables within a function  
---------------------------------------------------------------------------------------------
